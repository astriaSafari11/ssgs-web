      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <a href= "gm-performance-dashboard.php" class="btn btn-secondary position-relative" style="font-weight: 600; border-radius: 50px; color: #001F82;">
                  Request List
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="card-tools">
                      <button type="button" class="btn btn-danger position-relative" style="font-weight: 600; border-radius: 50px; width: 150px;" data-bs-toggle="modal" data-bs-target="#modal-default">
                        Export
                      </button>                       
                  ...
                  <div class="card-body">
                    <table id="example" class="table table-striped" style="width:100%">
                      <thead>
                          <tr >
                              <th style="color: #fff;background-color: #001F82;text-align: center;">Req</th>
                      ...
                      <tbody>
                          <tr>
                              <td style="vertical-align: middle;text-align: center;">REQ001</td>
                              ...
                              <td style="vertical-align: middle;text-align: center;background-color: #ed2f2f;color: #fff;">Rejected</td>
                          ...
                          <tr>
                            ...
                            <td style="vertical-align: middle;text-align: center;">100</td>
                            <td style="vertical-align: middle;text-align: center;">ml</td>
                            <td style="vertical-align: middle;text-align: center;background-color: #001F82;color: #fff;">Approved</td>
                            <td style="vertical-align: middle;text-align: center;">                
                              <button type="button" class="btn btn-sm btn-secondary" style="border-radius: 50px; color: #001F82;">
                              Feedback
                              </button>  
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel" class="text-bg-danger">SSGS - Export</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  Do you want to export data from SSGS?
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="color: #001F82;">No</button>
